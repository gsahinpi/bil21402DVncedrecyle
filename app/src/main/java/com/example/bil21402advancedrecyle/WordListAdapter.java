...
public class WordListAdapter extends
    ...
    class WordViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            VolumeInfo tiklanan = mWordList.get(mPosition);
            // Change the word in the mWordList.
           Intent action=new Intent(view.getContext(),showdetails.class);
           action.putExtra("volinfoobject", (Serializable) tiklanan);
           view.getContext().startActivity(action);
            //mWordList.set(mPosition, "Clicked! " + elemetiklanant);
    ...
    public void onBindViewHolder(WordListAdapter.WordViewHolder holder,
        ...
        String mCurrent2=mWordList.get(position).getAuthors();
